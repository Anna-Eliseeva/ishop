...
<div class="header">
        <a href="/"><img class="logo" src="/view/images/logo.jpg" alt="Интернет магазин сотовых телефонов" /></a>
        <img class="slogan" src="/view/images/slogan.jpg" alt="Интернет магазин сотовых телефонов" />
...
Суббота, Воскресенье - выходные  </p>
        ...
        //]]>
            ...
            <li><input type="image" class="serch-btn" src="/view/images/searc-btn.jpg" /></li>
        </ul>
        </form>
    </div>
    <ul class="menu">
